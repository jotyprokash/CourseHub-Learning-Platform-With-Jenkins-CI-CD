...
with Diagram(
    ...
    jenkins_ec2 >> Edge(label="2. Security Gates", style="dashed", color="#E11D48") >> secrets_scan
    secrets_scan >> Edge(style="dashed", color="#E11D48") >> sast_scan
    sast_scan >> Edge(style="dashed", color="#E11D48") >> sca_scan
    sca_scan >> Edge(style="dashed", color="#E11D48") >> iac_scan
    ...
    image_scan >> Edge(label="5. Store", color="#2563EB") >> artifact_repo
